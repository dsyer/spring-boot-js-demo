...
So it is definitely possible to replace our Turbo (and HTMX) code with Vue (or another library or even plain Javscript), but it inevitably involves some boilerplate Javascript.
