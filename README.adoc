...
(Chart.js isn't actually an ESM module, so `Chart` is defined as a global, and we can still use it in our React component, even though that isn't defined in the same script.)
